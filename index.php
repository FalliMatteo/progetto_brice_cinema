    ...
    <div class="container access_page">
        <div class="box access_form">
            <form action="php/createUtente.php" method="post">
                ...
                <div class="input_group">
                    <input id="input_email" type="email" name="email" placeholder="E-mail" class="input_field" required>
                </div>
                <div class="input_group">
                    <input id="input_nome" type="text" name="nome" placeholder="Nome" class="input_field" required>
                </div>
                <div class="input_group">
                    <input id="input_cognome" type="text" name="cognome" placeholder="Cognome" class="input_field" required>
                </div><br>
                <button type="submit">Registrati</button>
            </form>
            <button class="access_button" onclick="window.location.href = 'pages/login.php'">Accedi</button>
        </div>
        <br>
        <?php
