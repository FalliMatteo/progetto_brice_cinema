<?php
    ...
    function getRecensioni($connection){
        try{
            ...
            if($result->num_rows > 0){
                $string = "<div class='container'>Recensioni presenti nel database: <br><br><ul>";
    ...
    function getFilm($connection){
        try{
            ...
            $result = $connection->query($sql);
            if($result->num_rows > 0){
                $string = "<div class='container'>Film presenti nel database: <br><br><ul>";
                while($row = $result->fetch_assoc()){
...
<body>
    ...
    <br>
    <form id="form" action="php/insert.php" method="post" class="container col-xs-12 col-md-6">
